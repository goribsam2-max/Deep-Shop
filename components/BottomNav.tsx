...
const BottomNav: React.FC = () => {
  return (
    <div className="fixed bottom-4 left-4 right-4 h-16 glass rounded-ios-lg shadow-2xl border border-white/40 dark:border-white/10 z-50 flex items-center justify-around px-2 md:hidden">
      <NavLink 
        to="/" 
